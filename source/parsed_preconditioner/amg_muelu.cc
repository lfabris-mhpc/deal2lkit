...
ParsedAMGMueLuPreconditioner::declare_parameters(ParameterHandler &prm)
{
  ...
  add_parameter(
    ...
    std::to_string(aggregation_threshold),
    Patterns::Double(0.0),
  ...
  add_parameter(
    prm,
    &var_const_modes,
    "Variable related to constant modes",
    var_const_modes,
    Patterns::Anything(),
  ...
  add_parameter(
    ...
    &smoother_overlap,
    "Smoother overlap",
    std::to_string(smoother_overlap),
    Patterns::Integer(0),
