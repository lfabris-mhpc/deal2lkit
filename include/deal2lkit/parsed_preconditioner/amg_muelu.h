...
#ifndef d2k_parsed_amg_muelu_preconditioner_h
#define d2k_parsed_amg_muelu_preconditioner_h
...
public:
   ...
   */
  ParsedAMGMueLuPreconditioner(
    const std::string & name                  = "AMGMueLu Preconditioner",
